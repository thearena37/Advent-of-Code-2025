...
// now all sequences need to be taken into account
// ! Need to find the factors of the length of numbers, and then use those factors to check each time, as opposed to just half
    // find factors function within each loop
